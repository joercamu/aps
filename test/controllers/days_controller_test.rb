...
class DaysControllerTest < ActionController::TestCase
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post :create, day: { available: @day.available, busy: @day.busy, day: @day.day, hours: @day.hours, machine_id: @day.machine_id, shifts: @day.shifts }
    end
  ...
  test "should update day" do
    patch :update, id: @day, day: { available: @day.available, busy: @day.busy, day: @day.day, hours: @day.hours, machine_id: @day.machine_id, shifts: @day.shifts }
    assert_redirected_to day_path(assigns(:day))
  end
