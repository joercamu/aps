...
class ModificationsControllerTest < ActionController::TestCase
  ...
  test "should create modification" do
    assert_difference('Modification.count') do
      post :create, modification: { body: @modification.body, order_id: @modification.order_id, priority: @modification.priority, state: @modification.state, type: @modification.type, user_id: @modification.user_id }
    end
  ...
  test "should update modification" do
    patch :update, id: @modification, modification: { body: @modification.body, order_id: @modification.order_id, priority: @modification.priority, state: @modification.state, type: @modification.type, user_id: @modification.user_id }
    assert_redirected_to modification_path(assigns(:modification))
  end
